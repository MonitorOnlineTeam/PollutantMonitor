...
const prefix = 'https://cs.chsdl.com:5017'+'/rest/PollutantSourceApi';
export const API = {
  // 获取公众号推送绑定状态
  GetUserOpenID:prefix+'/UserApi/GetUserOpenID',
  // 发送测试推送
  TestPushWeChatInfo:prefix+'/UserApi/TestPushWeChatInfo',
  // 解除绑定
  // ResetUserWechatInfo:prefix+'/UserApi/ResetUserWechatInfo',
  UnbindWechat:prefix+'/LoginApi/UnbindWechat',
  // 获取系统配置信息
  // GetSystemConfigInfo: prefix + '/LoginApi/ValidateAuthorCode',
  // 验证是否注册
  // SDLSMCIsRegister: prefix + '/SMCManagerApi/SDLSMCIsRegister',
  // SDLSMCIsRegister: prefix + '/AuthorityApi/RegisterWxApplets',
  SDLSMCIsRegister: prefix + '/LoginApi/RegisterWxApplets',
  // 获取地图空气站信息
  // getEntAndAirList: prefix + '/BaseDataApi/GetEntAndPoint',
  getEntAndAirList: prefix + '/EnterpriseApi/GetEntAndPoint',
  // 获取实时数据列表
  // GetRealTimeDataForPoint: prefix + '/SMCManagerApi/GetRealTimeDataForPoint',
  GetRealTimeDataForPoint: prefix + '/MonBasicDataApi/GetOnePointLatestRealTimeData',
  // 意见反馈
  // AddFeedback: prefix + '/SMCManagerApi/AddFeedback',
  AddFeedback: prefix + '/FeedbackApi/AddIdeaFeedback',
  // 获取污染物列表
  // GetPollutantList: prefix + '/SMCManagerApi/GetPollutantList',
  GetPollutantList: prefix + '/MonitorPollutantApi/GetPollutantListByDgimn',
  // 获取运维日志
  // GetMobileOperationPageList: prefix + '/TaskProcessingApi/GetMobileOperationPageList',
  GetMobileOperationPageList: prefix + '/OperationLogsApi/GetOperationLogsList',
  // 系统信息
  // GetPointEquipmentInfo: prefix + '/BaseDataApi/GetPointEquipmentInfo',
  GetPointEquipmentInfo: prefix + '/MonitorPointApi/GetPointSystemInfo',
  // 设备参数信息
  // GetPointEquipmentParameters: prefix + '/BaseDataApi/GetPointEquipmentParameters',
  GetPointEquipmentParameters: prefix + '/MonitorPointApi/GetPointEquipmentInfo ',
  // 获取历史数据
  // GetMonitorDatas: prefix + '/SMCManagerApi/GetMonitorDatas',
  GetMonitorDatas: prefix + '/MonBasicDataApi/GetAllTypeDataList',
  // 获取公司运维报警信息
  // GetAlarmInfoList: prefix + '/SMCManagerApi/GetWxAlarmList',
  GetAlarmInfoList: prefix + '/OverAlarmApi/GetWxAlarmList',
  // 续费记录
  // GetPersonalCenterOrder: prefix + '/TaskFormApi/GetPersonalCenterOrder',
  GetPersonalCenterOrder: prefix + '/CustomerRenew/GetAppCustomerRenewList',
  // 单点续费历史记录
  // GetGetPersonalCenterOrderInfo: prefix + '/TaskFormApi/GetGetPersonalCenterOrderInfo',
  GetGetPersonalCenterOrderInfo: prefix + '/CustomerRenew/GetAppCustomerRenewInfo',
  GetOverDataList:prefix + '/OperationWorkbenchApi/GetOverDataList',
  GetMonitorAlarmDatas:prefix + '/AlarmVerifyManageApi/GetMonitorAlarmDatas',
  GetAlarmCountForEnt:prefix + '/OperationWorkbenchApi/GetAlarmCountForEnt',
}


// const URL = 'https://api.chsdl.net/NewWryWebProxy/rest/PollutantSourceApi';
const URL = 'https://cs.chsdl.com:5017/rest/PollutantSourceApi';
